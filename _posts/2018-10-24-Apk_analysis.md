...
<div>
  <img src = "/images/android_reverse/apk_get.png" width="270" height="480" />
</div>
...
<div>
  <img src = "/images/android_reverse/apk_unzip.png" width="270" height="480" />
</div>
...
<div>
  <img src = "/images/android_reverse/apktool_apk.png" width="270" height="480" />
</div>

那么我们就得到了一个新的文件：
<div>
  <img src = "/images/android_reverse/apktool_finish.png" width="270" height="480" />
</div>

下面打开新得到的文件：
<div>
  <img src = "/images/android_reverse/buka.png" width="270" height="480" />
</div>

我使用Notepad++打开AndroidManifest.xml文件：
<div>
  <img src = "/images/android_reverse/androidmanifest.png" width="270" height="480" />
</div>
...
<div>
  <img src = "/images/android_reverse/dex2jar.png" width="270" height="480" />
</div>
...
<div>
  <img src = "/images/android_reverse/jd-gui_java_code.png" width="270" height="480" />
</div>
...
<div>
  <img src = "/images/android_reverse/enter_activity.png" width="270" height="480" />
</div>
 ...
 <div>
   <img src = "/images/android_reverse/adb_shell.png" width="270" height="480" />
 </div>
4、打开终端上的agent.apk，并开启：
<div>
  <img src = "/images/android_reverse/agent.png" width="270" height="480" />
</div>
5、我们去到Drozer目录下，打开命令行窗口，通过命令adb forward tcp:31415 tcp:31415，./drozer.bat console connect去连接终端：
<div>
  <img src = "/images/android_reverse/enter_drozer.png" width="270" height="480" />
</div>
6、我们先查看布卡漫画APK的攻击面，使用的命令是 run app.apckage.attacksurface 包名
<div>
  <img src = "/images/android_reverse/attacksurface.png" width="270" height="480" />
</div>
